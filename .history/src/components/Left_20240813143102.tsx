  ...
  return (
    <div>
      <motion.div
        ...
        className=" md:block bg-[#1C1C1C] w-full md:w-80  h-fit sticky top-5 "
      >
          ...
          <div className="flex">
            <div className="w-full relative">
              ...
              <div
                ...
                className="bg-lime-400 w-3 h-3 cursor-pointer rounded-full absolute top-20 animate-pulse right-[185px]"
              />

              {open && (
                <div className="border border-lime-400 h-5 flex items-center justify-center rounded-2xl w-fit px-2 absolute top-[4.7rem] right-1 ">
              ...
              <div className="mt-7 flex  justify-between">
                <div className="flex gap-x-3">
                  ...
                  <div className="-mt-1">
                    ...
                    <p className="text-[9px]">ISD Corp</p>
                  </div>
                </div>
              ...
              <div className="my-3 flex  justify-between">
                <div className="flex gap-x-3">
                  ...
                  <div className="-mt-1">
                    ...
                    <p className="text-[9px]">3S Hue Intersoft</p>
                  </div>
                </div>
                <small className="text-[9px] text-neutral-300">
                  2021 - July 2022
