  ...
  return (
    ...
    >
      <div className="  bg-[#1C1C1C] lg:bg-transparent rounded-2xl ">
        <div>
          <div className="flex items-center flex-col space-x-3 p-4">
            <h1 className="font-RubikBold text-neutral-200">My Projects</h1>
            <p className="text-xs my-2 text-neutral-400 font-RubikRegular">
              Take a look at the projects I’ve developed, each reflecting my
              dedication to creating robust and innovative solutions. From
              sophisticated web platforms to custom software applications, these
              projects demonstrate my technical skills and commitment to
              delivering exceptional user experiences. See how I apply my
              knowledge to solve real-world challenges and drive success.
            </p>
          </div>
