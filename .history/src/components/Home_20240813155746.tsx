  ...
  return (
    ...
    >
      <div className="  bg-[#1C1C1C] lg:bg-transparent rounded-2xl ">
        <div>
          <div className="flex items-center space--3 p-4">
            <PiCodeThin className="text-3xl" />
            <h1 className="text-2xl font-RubikMedium text-neutral-300">
              My Projects
            </h1>
            <p className="text-xs my-3 text-neutral-400 font-RubikRegular">
              Here you can find a collection of projects that reflect my
              technical capabilities and creative solutions. Each project is
              presented with an overview of the objectives, technologies
              utilized, and the results achieved, giving you a glimpse into my
            ...
            <div className="hover:bg-neutral-800 duration-200 transition-all ease-in p-4">
              <div className="  flex items-center space--3">
                <div>
                  ...
                  <div className="flex items-center space--2 font-RubikBold">
