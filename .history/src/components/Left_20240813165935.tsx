  ...
  return (
    <div>
      <motion.div
        ...
        className=" md:block bg-[#1C1C1C] w-full md:w- lg:w-80 h-fit sticky top-5 "
      >
        <div className=" md:w-70 w-full p-5 lg:p-3 border border-neutral-800 rounded-2xl h-full bg-[#1C1C1C]  ">
          <div className="flex">
