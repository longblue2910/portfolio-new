        ...
        <div>
          <div className="flex items-center gap-x-3 p-4">
            ...
            <p className="text-xs my-3 text-neutral-400 font-RubikRegular">
              Here you can find a collection of projects that reflect my technical capabilities and creative solutions. Each project is presented with an overview of the objectives, technologies utilized, and the results achieved, giving you a glimpse into my approach and expertise.
