  ...
  return (
    ...
    >
      <div className="  bg-[#1C1C1C] lg:bg-transparent rounded-2xl ">
        <div>
          <div className="flex items-center space-x-3 p-">
          ...
          <div className="flex items-center space-x-3 p-3">
            <p className="text-xs text-neutral-400 font-RubikRegular">
              ...
              <br />
              projects demonstrate my technical skills and commitment to <br />
              delivering exceptional user experiences. See how I apply my <br />
