          ...
          <div className="flex">
            <div className="w-full relative">
              ...
              <div
                ...
                className="bg-lime-400 w-3 h-3 cursor-pointer rounded-full absolute top-20 right-[133px] animate-pulse"
              />
            ...
            <div className="hidden md:block flex gap-x-1 w-full h-fit">
              <Link href={"/"}>
