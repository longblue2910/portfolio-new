      ...
      <div className=" md:w-60 w-full rounded-2xl h-fit sticky top-5 ">
        <div>
          <div className="bg-[#1C1C1C] min-w-min rounded-2xl p-4 border border-neutral-800 h-fit">
            ...
            <button className="flex items-center justify-center gap-2 bg-[#696969] h-7 p-1 rounded-md text-xs w-full font-RubikMedium text-neutral-50" onClick={downloadFile}>
              <span>Download</span>
